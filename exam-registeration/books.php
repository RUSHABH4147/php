      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="books.php">Exam books</a></li>
...
<div class="shell" style="padding:30px; margin:3%">
<?php
            session_start();
        ?>
<center>
   <form>
        <h1>Welcome  <?php echo $_SESSION['id']?> </h1><br>
        <p><b>Explore </b>books here!!</p>
</form>
</center><hr>
<div class="row row-cols-1 row-cols-md-3 g-4 ">
  <div class="col">
    <div class="card h-100">
      <img src="book.jpg" class="card-img-top" style="width: 400px;height: 400px;"alt="...">
      <div class="card-body">
